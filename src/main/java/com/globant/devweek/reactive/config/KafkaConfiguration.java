package com.globant.devweek.reactive.config;
...
public class KafkaConfiguration {
    ...
    KafkaReceiver kafkaReceiver() {
        ...
        configProps.put(ConsumerConfig.CLIENT_ID_CONFIG, "globant-demo");
        configProps.put(ConsumerConfig.GROUP_ID_CONFIG, "globant-demo");
        configProps.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, true);

        return new DefaultKafkaReceiver(ConsumerFactory.INSTANCE,
                ReceiverOptions.create(configProps).subscription(Arrays.asList(topic))
        );
    }
